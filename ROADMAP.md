...
| `S01g-premium-timeline` | Calm narrative timeline without proof/debug dominance | S01e | done |
| `S01h-active-plan-projection` | Daemon-backed repo plan projection for Inspector Plan | S01g | done |
...
| `S05e-claude-receipt-detail-snapshot` | Read-only daemon-owned Claude receipt detail snapshot в timeline/inspector | S05d | done |
